...
class V1::OauthControllerTest < ActionDispatch::IntegrationTest
  setup do
    @user = users(:aidistan)
  end

  test 'should not login' do
    get v1_oauth_login_url, as: :json
    assert_response :forbidden
  end

  test 'should not authorize' do
    get v1_oauth_authorize_url, as: :json
    assert_response :forbidden
  end

  test 'should reject access_token without http authentication' do
    post v1_oauth_access_token_url, as: :json
    assert_response :unauthorized
  end

  test 'should reject access_token without grant_type' do
    post v1_oauth_access_token_url, headers: headers_with_credentials, as: :json
    assert_response :bad_request
  end

  test 'should support resource owner passwod credentials grant' do
    post v1_oauth_access_token_url,
